...
// @require      https://raw.githubusercontent.com/NikkiMannaro/6.8/main/anchor-browserified.js
// @require      https://raw.githubusercontent.com/NikkiMannaro/6.8/main/buffer-browserified.js
// @require      https://raw.githubusercontent.com/NikkiMannaro/6.8/main/bs58-browserified.js
		...
		return new Promise(async resolve => {
            ...
            if (globalSettings.saveProfile && globalSettings.savedProfile && globalSettings.savedProfile.length > 0) {
                ...
                if (globalSettings.saveProfile) {
                    ...
                    */
                    globalSettings.savedProfile = [userProfileAcct.toString(), userProfileKeyIdx];
